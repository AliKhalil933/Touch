...
import 'package:flutter_project/core/widgets/Product_Card_For_MaxBuy.dart';
...
SizedBox BulidMaxbuyProdectList() {
  return SizedBox(
    height: 200,
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(onTap: () {Navigator.pushNamed(context, CategoryPageView.routeName);},
          child: ProductCardForMaxBuy(
