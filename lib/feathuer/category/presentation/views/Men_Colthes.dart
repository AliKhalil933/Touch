...
class MenColthes extends StatefulWidget {
  const MenColthes({super.key});
  static const routeName = 'MenColthes';

  @override
  State<MenColthes> createState() => _MenColthesState();
}

class _MenColthesState extends State<MenColthes> {
  String selectedSort = 'اختر';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BuildAppBar(context, Title: 'ملابس رجالية'),
