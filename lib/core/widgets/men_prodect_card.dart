...
class MenProductCard extends StatelessWidget {
  const MenProductCard({
    super.key,
    required this.imageUrl, // إضافة صورة المنتج كخاصية
    required this.productName, // إضافة اسم المنتج كخاصية
    required this.productPrice, // إضافة سعر المنتج كخاصية
  });
